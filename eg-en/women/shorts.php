...
<html>
<head>
<title>Shorts | Modern, Modest Fashion</title>
...
if(isset($_GET['sort']) && $_GET['sort'] !== "" && $_GET['sort'] == 'best-seller') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' ORDER BY buyers DESC LIMIT $from, $num_per_page";
} elseif(isset($_GET['sort']) && $_GET['sort'] !== "" && $_GET['sort'] == 'high-low') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' ORDER BY price DESC LIMIT $from, $num_per_page";

} elseif(isset($_GET['sort']) && $_GET['sort'] !== "" && $_GET['sort'] == 'low-high') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' ORDER BY price ASC LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == '4') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%4%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == '6') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%6%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == '8') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%8%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == '10') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%10%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == '12') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%12%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == '14') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%14%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == '16') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%16%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == '18') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%18%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == '20') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%20%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == '22') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%22%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == 'XS') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%<option>XS</option>%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == 'S') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%<option>S</option>%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == 'M') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%<option>M</option>%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == 'L') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%<option>L</option>%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == 'XL') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%<option>XL</option>%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == 'XXL') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%<option>XXL</option>%' LIMIT $from, $num_per_page";

} elseif(isset($_GET['size']) && $_GET['size'] !== "" && $_GET['size'] == 'XXXL') {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' AND sizes LIKE '%<option>XXXL</option>%' LIMIT $from, $num_per_page";

} else {
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts' ORDER BY id DESC LIMIT $from, $num_per_page";
}
...
?>
<?php
    $sql = "SELECT * FROM products_women WHERE subcategory = 'Shorts'";
    $query = mysqli_query($connect, $sql);
