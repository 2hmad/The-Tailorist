...
if($main_pic_name !== "" && $main_pic_name !== "$pic_one" && move_uploaded_file($_FILES["main-pic"]["tmp_name"], $targetFilePathMain)){
  ...
  if($product_category === "Women") {
    ...
    (name, price, subcategory, sizes, fabric, size_model, weight, dedicated_to, product_details, main_pic, second_pic, third_pic, fourth_pic) 
    VALUES ('$product_name', '$product_price', '$product_subcategory', '$available_sizes', '$fabric', '$size_model', '$weight', '$dedicate', '$details', '$main_pic_name', '$second_pic_name', '$third_pic_name', '$fourth_pic_name')";    
  } elseif($product_category === "Men") {
