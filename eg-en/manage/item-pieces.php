...
?>
<div class="container">
<div class="edit-pieces">
<span style="text-align:center;font-weight:bold;font-size:25px;display:block;margin-bottom: 5%;margin-top: 1%;">Edit Pieces</span>
...
<form method="POST">
  ...
  <label style="display: block;font-weight: bold;text-transform: capitalize;margin-top: 3%;">Pieces <span style="font-size: 0.9rem;color: red;">(0 = Out of stock)</span></label>
  <input type="number" name="product-pieces" min="0" style="width: 100%;display: block;padding: 5px;border-radius: 5px;border: 1px solid #CCC;outline: none;" required>
  <button type="submit" name="edit-pieces" class="edit-button">Edit Pieces</button>
</form>
<?php
if(isset($_POST['edit-pieces'])) {
  $product_id = $_POST['product-id'];
  $product_category = $_POST['product-category'];
  $pieces = $_POST['product-pieces'];
  if($product_category === "Women") {
    ...
    if($num > 0) {
      ...
      $sql = "INSERT INTO pieces (product_name, product_id, category, pieces) VALUE ('$name', '$product_id', '$product_category', '$pieces')";
      $query = mysqli_query($connect, $sql);
      echo "<div class='alert alert-success'>You edited product's pieces</div>";
    } else {
